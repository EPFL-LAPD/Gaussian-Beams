...
using ABCDMatrixOptics, Plots, PlutoUI

# ╔═╡ d9bd754b-327b-4b2b-8715-85a271fda3a9
using LsqFit
...
md"""# Basics of Gaussian Beam
See also [Wikipedia](https://en.wikipedia.org/wiki/Gaussian_beam).


${E(r,z)} = E_0  \, \frac{w_0}{w(z)}\exp \left( \frac{-r^2}{w(z)^2}\right) \exp \left( -i \left(kz +k \frac{r^2}{2R(z)} - \psi(z) \right) \right)$


where the beam waist is given by
...
w_after_lens = ABCDMatrixOptics.w([ThinLens(4.5e-3), FreeSpace(4.5e-3)] * gb)

# ╔═╡ e69e2710-be1b-4821-8f19-a0d74e28d085
md"""
The waist given after focussing is $(round(w_after_lens, digits=7))m
"""


# ╔═╡ 3278db7c-abb7-4afb-a328-830eb81f9439
...
# ╔═╡ 0c3c78d4-124c-4962-a312-b59e5d738f34
model(z, p) = z .* p[1] .+ p[2]

# ╔═╡ a1d9b6fc-616a-4375-b0d1-5d36ee2eee01
fit_bounds = curve_fit(model, zs, w_z, [1.0, 1.0])

# ╔═╡ 36291ef8-b47e-48c4-b64b-25c91b688cef
ps = fit_bounds.param

# ╔═╡ ed587b8e-7f20-4740-9f08-f6bff77493d2
θ = fit_bounds.param[1]

# ╔═╡ 0ffe9473-8711-4184-be86-d35b87076a77
md"
The fitted $\theta$ = $(round(ps[1], digits=5))

"

# ╔═╡ 55a68ed4-52fb-4f54-9f97-f99732da7eac
begin
	plot(zs, w_z, label="Measurements", xlabel="z in meter", ylabel="\$w(z)\$ in meter")
	plot!(zs, model(zs, ps), label="Linear fit")
end

# ╔═╡ 64117772-d239-4f14-93b3-c9fc812f4c31
md"The initial beam diameter is given by"
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "5462ae4bb5e0a9a11904c59f562ba5b098385062"

[[deps.ABCDMatrixOptics]]
deps = ["Colors", "Interpolations", "Parameters", "PrecompileTools", "RecipesBase"]
git-tree-sha1 = "b1f7298b2e6a29e1e0600340b6dd8837cd5df4fe"
